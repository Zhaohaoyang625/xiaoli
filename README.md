...
启动后：
- **终端**直接打字聊天；「说」开口说话；「语音开/关」「通话开/关」切模式；
  「记住XXX」让她牢牢记着一件事；「记忆」看她记得什么；「心情」看她的心；
  「简报」她今天知道的世界；「备份」一键打包数据
- **网页**：浏览器打开 `web/XiaoLi.html`（建议放桌面快捷方式）——打字聊天、🎤说话、
  📷传照片、🔊开关声音，底部气泡面板显示最近对话（刷新不丢）
